 ...
 *
 */
namespace Intenso\Review\Block\Adminhtml\Review;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    protected function _prepareCollection()
    {
        ...
        if (!isset($filters['status'])) {
            $collection->addFilter('status', $collection->getConnection()->quoteInto('rt.status_id<?', \Intenso\Review\Model\Review::STATUS_SPAM), 'string');
        }
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem(
            ...
            [
                ...
                'url' => $this->getUrl(
                    'intenso_review/review/massUpdateStatus',
                    ['ret' => $this->_coreRegistry->registry('usePendingFilter') ? 'pending' : 'index']
                ),
                'additional' => [
                    'status' => [
