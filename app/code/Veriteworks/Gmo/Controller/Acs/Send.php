...
class Send extends Action
{
    ...
    public function execute()
    {
        ...
        if ($this->session->getCentinelUrl()
            ...
            $data->setPareq($this->session->getPareq());
            $data->setMd($this->session->getMd());
            $data->setTermUrl($this->_url->getUrl('gmo/acs/receive', ['_secure'=>true]));
            $this->logger->debug($method);

            $this->logger->debug(var_export($data->toArray(), true));
            $block->setAcsData($data);
